...
class AreaCodeForgotPassword extends StatelessWidget {
  const AreaCodeForgotPassword({
    super.key,
  });
        ...
        builder: (context, state) {
          return GestureDetector(
              ...
              showModalBottomSheet<void>(
                ...
                builder: (BuildContext ctx) {
                  ...
                  return AreaCodeSelector(
                    ...
                    items: state,
                    onTap: (v) {
                      context.read<ForgotPasswordCubit>().changePrefix(
                            prefix: v,
                          );
            ...
            child: Container(
              ...
              child: Center(
                child:
                    BlocSelector<ForgotPasswordCubit, ForgotPasswordState, int>(
                  selector: (state) {
                    return state.prefix;
                  },
